//! Message view types for rendering individual chat messages.
...
/// Renders a single chat message including all its parts.
...
impl MessageView {
    /// Create a new message view for the given role.
    ...
    /// Render all message parts into the given area.
